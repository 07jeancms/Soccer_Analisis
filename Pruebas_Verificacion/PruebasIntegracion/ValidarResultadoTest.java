...
public class ValidarResultadoTest {
	...
	public void test() {
		...
		InfoReporte reporte = segmentacion.validarResultado(listaArchivo);
		
		int resultadoesperado = 151;
		
		assertEquals( resultadoesperado , reporte.getCantFalsoPosivitos());
